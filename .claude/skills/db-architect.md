...
2. 왼쪽 메뉴 **SQL Editor** → `project/db-design.md`의 SQL 블록 전체 복사 → **Run**
3. **Project URL과 Publishable Key** 확인 방법:
   > **Project Overview** 첫 화면에서 프로젝트 URL 왼쪽의 **🔌 아이콘에 마우스를 올리면** Project URL과 Publishable Key가 팝업으로 나타납니다. 두 값을 채팅으로 알려 주세요!
